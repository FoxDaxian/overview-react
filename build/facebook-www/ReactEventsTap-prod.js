            ...
            if (!state.isActive) {
              ...
              nativeEvent =
                1 === nativeEvent.button
                  ...
                  : nativeEvent.buttons;
              pointerId = isAuxiliary(nativeEvent, event);
              if (eventTarget || pointerId)
                (state.buttons = nativeEvent),
                  (state.pointerType = event.pointerType),
              ...
              pointerId
                ...
                : eventTarget &&
                  ...
                  null != event &&
                    ((eventType = context.objectAssign({}, state.gestureState, {
                      type: "tap:start"
                    })),
                    context.dispatchEvent(eventType, event, 0)),
                  dispatchChange(context, props, state));
            } else if (
