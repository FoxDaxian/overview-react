...
var _require = require("ReactFeatureFlags"),
  ...
  enableTrainModelFix = _require.enableTrainModelFix,
    ...
    batchedEventUpdates$1(function() {
      ...
      for (pointerType = !1; null !== buttons; ) {
        ...
        if (4 === _node) pointerType = !0;
          ...
          for (
            var responderInstances = Array.from(eventPointerType.values()),
              i = 0,
            ...
            eventPointerType = responderInstance.props;
            var responder = responderInstance.responder;
            _node = responderInstance.state;
            var JSCompiler_temp;
              ...
              if (
                ...
                a: {
                  for (
                    ...
                    var eventType = JSCompiler_temp[i$jscomp$0];
                    if (
      ...
      if (0 < visitedResponders.length)
        for (
          ...
          (buttons = isPassiveSupported[visitedResponders]),
            (eventPointerType = buttons.props),
            (responder = buttons.responder),
            (_node = buttons.state),
            (pointerType = responder.onRootEvent),
            null !== pointerType &&
...
function trapReplayableEvent(topLevelType, document, listenerMap) {
  ...
  listenerMap.has(passiveEventKey) ||
    ((topLevelType = addResponderEventSystemEvent(document, topLevelType, !0)),
    listenerMap.set(passiveEventKey, topLevelType));
}
...
function ensureListeningTo(rootContainerElement, registrationName) {
  ...
  var listeningSet = getListenerMapForElement(rootContainerElement);
...
var classComponentUpdater = {
  ...
  enqueueReplaceState: function(inst, payload, callback) {
    ...
    currentTime = computeExpirationForFiber(currentTime, inst, suspenseConfig);
    suspenseConfig = createUpdate(currentTime, suspenseConfig);
    suspenseConfig.tag = ReplaceState;
    suspenseConfig.payload = payload;
    void 0 !== callback &&
      null !== callback &&
      (suspenseConfig.callback = callback);
  ...
  switch (finishedWork.tag) {
    ...
    case 5:
      ...
      if (null != instance) {
        ...
        (oldProps.DEPRECATED_flareListeners === instance &&
          null !== current$$1) ||
    ...
    case 13:
      ...
      oldProps = finishedWork;
      null === current$$1
        ? (instance = !1)
        : ((instance = !0),
          (oldProps = finishedWork.child),
          (globalMostRecentFallbackTime = now()));
      if (null !== oldProps)
        a: for (newProps = oldProps; ; ) {
          if (5 === newProps.tag)
              ...
              instance
                ? ((type = type.style),
                  "function" === typeof type.setProperty
                    ...
                    : (type.display = "none"))
                : ((type = newProps.stateNode),
                  (updatePayload = newProps.memoizedProps.style),
                  (updatePayload =
                    ...
                    updatePayload.hasOwnProperty("display")
                      ...
                      : null),
                  (type.style.display = dangerousStyleValue(
                    "display",
                    updatePayload
                  )));
          else if (6 === newProps.tag)
            newProps.stateNode.nodeValue = instance
              ? ""
              : newProps.memoizedProps;
          else if (
            13 === newProps.tag &&
            null !== newProps.memoizedState &&
            null === newProps.memoizedState.dehydrated
          ) {
            type = newProps.child.sibling;
            type.return = newProps;
            newProps = type;
            continue;
          ...
          if (newProps === oldProps) break a;
          for (; null === newProps.sibling; ) {
            if (null === newProps.return || newProps.return === oldProps)
              break a;
      ...
      null !== current$$1 &&
        ...
        "function" === typeof current$$1 &&
          ((oldProps = finishedWork.updateQueue),
          null !== oldProps && current$$1(new Set(oldProps))));
    ...
    case 21:
      ...
      oldProps = finishedWork.memoizedProps;
      instance = oldProps.DEPRECATED_flareListeners;
      ((null !== current$$1 ? current$$1.memoizedProps : oldProps)
        .DEPRECATED_flareListeners === instance &&
        null !== current$$1) ||
        updateLegacyEventListeners(instance, finishedWork, null);
      break;
    default:
...
function getNextRootExpirationTimeToWorkOn(root) {
  ...
  return enableTrainModelFix && 2 >= root && lastExpiredTime !== root
    ? 0
    : root;
}
  ...
  do {
    ...
    if (0 === (workInProgress.effectTag & 2048)) {
      a: {
        ...
        switch (current$$1.tag) {
          ...
          case 5:
            ...
            var JSCompiler_inline_result$jscomp$0 = current$$1.type;
            if (null !== current && null != current$$1.stateNode)
              updateHostComponent$1(
                ...
                current.memoizedProps.DEPRECATED_flareListeners !==
                  JSCompiler_inline_result.DEPRECATED_flareListeners &&
                  markUpdate(current$$1),
              ...
              if (popHydrationState(current$$1)) {
                JSCompiler_inline_result$jscomp$0 = current$$1;
                current = JSCompiler_inline_result$jscomp$0.stateNode;
                var type = JSCompiler_inline_result$jscomp$0.type,
                  props = JSCompiler_inline_result$jscomp$0.memoizedProps,
                ...
                JSCompiler_inline_result$jscomp$0.updateQueue = renderExpirationTime$jscomp$0;
                JSCompiler_inline_result$jscomp$0 =
                  null !== renderExpirationTime$jscomp$0 ? !0 : !1;
                JSCompiler_inline_result$jscomp$0 && markUpdate(current$$1);
                null != JSCompiler_inline_result.DEPRECATED_flareListeners &&
                  markUpdate(current$$1);
              } else {
                current = current$$1;
                props = JSCompiler_inline_result$jscomp$0;
                ...
                currentHostContext === Namespaces.html
                  ? "script" === props
                    ? ((type = rootContainerInstance.createElement("div")),
                      (type.innerHTML = "<script>\x3c/script>"),
                      (rootContainerInstance = type.removeChild(
                        type.firstChild
                      )))
                    : "string" === typeof type.is
                      ? (rootContainerInstance = rootContainerInstance.createElement(
                          props,
                          { is: type.is }
                        ))
                      : ((rootContainerInstance = rootContainerInstance.createElement(
                        ...
                        "select" === props &&
                          ...
                          type.multiple
                            ? (props.multiple = !0)
                            : type.size && (props.size = type.size)))
                  : (rootContainerInstance = rootContainerInstance.createElementNS(
                      currentHostContext,
                      props
                    ));
                type = rootContainerInstance;
                type[internalInstanceKey] = current;
                type[internalEventHandlersKey] = JSCompiler_inline_result;
                appendAllChildren(type, current$$1, !1, !1);
                current$$1.stateNode = type;
                null != JSCompiler_inline_result.DEPRECATED_flareListeners &&
                  markUpdate(current$$1);
                props = JSCompiler_inline_result$jscomp$0;
                current = JSCompiler_inline_result;
                var rootContainerElement = renderExpirationTime$jscomp$0,
                  isCustomComponentTag = isCustomComponent(props, current);
                switch (props) {
                  case "iframe":
                  case "object":
                  case "embed":
                  ...
                  case "input":
                    ...
                    renderExpirationTime$jscomp$0 = getHostProps(type, current);
                  ...
                  case "select":
                    ...
                    renderExpirationTime$jscomp$0 = Object.assign({}, current, {
                      value: void 0
                    });
                    trapBubbledEvent("invalid", type);
                    ensureListeningTo(rootContainerElement, "onChange");
                ...
                assertValidProps(props, renderExpirationTime$jscomp$0);
                rootContainerInstance = void 0;
                currentHostContext = props;
                nextProp = type;
                var nextProps = renderExpirationTime$jscomp$0;
                for (rootContainerInstance in nextProps)
                  if (nextProps.hasOwnProperty(rootContainerInstance)) {
                    var nextProp$jscomp$0 = nextProps[rootContainerInstance];
                    "style" === rootContainerInstance
                      ? setValueForStyles(nextProp, nextProp$jscomp$0)
                      : "dangerouslySetInnerHTML" === rootContainerInstance
                        ? ((nextProp$jscomp$0 = nextProp$jscomp$0
                            ? nextProp$jscomp$0.__html
                            : void 0),
                          null != nextProp$jscomp$0 &&
                            setInnerHTML(nextProp, nextProp$jscomp$0))
                        : "children" === rootContainerInstance
                          ? "string" === typeof nextProp$jscomp$0
                            ? ("textarea" !== currentHostContext ||
                                "" !== nextProp$jscomp$0) &&
                              setTextContent(nextProp, nextProp$jscomp$0)
                          ...
                          : "DEPRECATED_flareListeners" !==
                            ...
                            "suppressHydrationWarning" !==
                              rootContainerInstance &&
                            "autoFocus" !== rootContainerInstance &&
                            (registrationNameModules.hasOwnProperty(
                              rootContainerInstance
                            )
                              ? null != nextProp$jscomp$0 &&
                ...
                switch (props) {
                  case "input":
                    track(type);
                    postMountWrapper(type, current, !1);
                    break;
                  case "textarea":
                    track(type);
                  ...
                  case "option":
                    null != current.value &&
                      type.setAttribute(
                        "value",
                        "" + getToStringValue(current.value)
                      );
                    break;
                  case "select":
                    renderExpirationTime$jscomp$0 = type;
                    renderExpirationTime$jscomp$0.multiple = !!current.multiple;
                    type = current.value;
                    null != type
                      ? updateOptions(
                          renderExpirationTime$jscomp$0,
            ...
            if (current && null != current$$1.stateNode)
              ...
              popHydrationState(current$$1)
                ? ((JSCompiler_inline_result = current$$1),
                  ...
                  (renderExpirationTime$jscomp$0 =
                    JSCompiler_inline_result.memoizedProps),
                  (JSCompiler_inline_result$jscomp$0[
                    internalInstanceKey
                  ] = JSCompiler_inline_result),
                  (JSCompiler_inline_result =
                    JSCompiler_inline_result$jscomp$0.nodeValue !==
                    renderExpirationTime$jscomp$0) && markUpdate(current$$1))
                : ((JSCompiler_inline_result$jscomp$0 = current$$1),
                  (JSCompiler_inline_result = (9 ===
                  renderExpirationTime$jscomp$0.nodeType
                    ? renderExpirationTime$jscomp$0
                    : renderExpirationTime$jscomp$0.ownerDocument
                  ...
                  (current$$1.stateNode = JSCompiler_inline_result));
            }
            break;
          case 11:
            break;
          case 13:
            ...
            if (
              null !== JSCompiler_inline_result &&
              null !== JSCompiler_inline_result.dehydrated
            ) {
              if (null === current) {
                if (!popHydrationState(current$$1))
                ...
                JSCompiler_inline_result[internalInstanceKey] = current$$1;
              } else
                resetHydrationState(),
            ...
            null === current
              ? void 0 !== current$$1.memoizedProps.fallback &&
                popHydrationState(current$$1)
            ...
            JSCompiler_inline_result &&
              ...
              0 !==
                ...
                ? workInProgressRootExitStatus === RootIncomplete &&
                  (workInProgressRootExitStatus = RootSuspended)
                : renderDidSuspendDelayIfPossible());
            if (JSCompiler_inline_result || JSCompiler_inline_result$jscomp$0)
              current$$1.effectTag |= 4;
          ...
          case 19:
            pop(suspenseStackCursor, current$$1);
            JSCompiler_inline_result = current$$1.memoizedState;
            if (null === JSCompiler_inline_result) break;
            JSCompiler_inline_result$jscomp$0 =
              0 !== (current$$1.effectTag & 64);
            type = JSCompiler_inline_result.rendering;
            if (null === type)
                ...
                if (
                  ...
                  for (current = current$$1.child; null !== current; ) {
                    ...
                    if (null !== type) {
                      ...
                      cutOffTailIfNeeded(JSCompiler_inline_result, !1);
                      JSCompiler_inline_result$jscomp$0 = type.updateQueue;
                      null !== JSCompiler_inline_result$jscomp$0 &&
                        ((current$$1.updateQueue = JSCompiler_inline_result$jscomp$0),
                        (current$$1.effectTag |= 4));
                      null === JSCompiler_inline_result.lastEffect &&
                        (current$$1.firstEffect = null);
                      current$$1.lastEffect =
                        JSCompiler_inline_result.lastEffect;
                      JSCompiler_inline_result = renderExpirationTime$jscomp$0;
                      for (
                        JSCompiler_inline_result$jscomp$0 = current$$1.child;
                        null !== JSCompiler_inline_result$jscomp$0;

                      )
                        (renderExpirationTime$jscomp$0 = JSCompiler_inline_result$jscomp$0),
                          (current = JSCompiler_inline_result),
                          ...
                          null === type
                            ? ((renderExpirationTime$jscomp$0.childExpirationTime = 0),
                              (renderExpirationTime$jscomp$0.expirationTime = current),
                          ...
                          (JSCompiler_inline_result$jscomp$0 =
                            JSCompiler_inline_result$jscomp$0.sibling);
                      push(
                        suspenseStackCursor,
              ...
              if (!JSCompiler_inline_result$jscomp$0)
                if (((current = findFirstSuspended(type)), null !== current)) {
                  if (
                    ...
                    current$$1 = current$$1.lastEffect =
                      JSCompiler_inline_result.lastEffect;
                    null !== current$$1 && (current$$1.nextEffect = null);
                    break;
                  }
                } else
                  2 * now() - JSCompiler_inline_result.renderingStartTime >
                    JSCompiler_inline_result.tailExpiration &&
              ...
              JSCompiler_inline_result.isBackwards
                ...
                : ((renderExpirationTime$jscomp$0 =
                    JSCompiler_inline_result.last),
                  null !== renderExpirationTime$jscomp$0
                    ? (renderExpirationTime$jscomp$0.sibling = type)
                    : (current$$1.child = type),
                  (JSCompiler_inline_result.last = type));
            }
            if (null !== JSCompiler_inline_result.tail) {
              0 === JSCompiler_inline_result.tailExpiration &&
                (JSCompiler_inline_result.tailExpiration = now() + 500);
              renderExpirationTime$jscomp$0 = JSCompiler_inline_result.tail;
              JSCompiler_inline_result.rendering = renderExpirationTime$jscomp$0;
              JSCompiler_inline_result.tail =
                renderExpirationTime$jscomp$0.sibling;
              JSCompiler_inline_result.lastEffect = current$$1.lastEffect;
              JSCompiler_inline_result.renderingStartTime = now();
              renderExpirationTime$jscomp$0.sibling = null;
              JSCompiler_inline_result = suspenseStackCursor.current;
              JSCompiler_inline_result = JSCompiler_inline_result$jscomp$0
                ? (JSCompiler_inline_result & SubtreeSuspenseContextMask) |
                  ForceSuspenseFallback
                : JSCompiler_inline_result & SubtreeSuspenseContextMask;
              push(suspenseStackCursor, JSCompiler_inline_result, current$$1);
          ...
          case 21:
            null === current
              ? ((JSCompiler_inline_result$jscomp$0 = current$$1.type),
                (renderExpirationTime$jscomp$0 = {
                  fiber: current$$1,
                  methods: null
                }),
      ...
      if (
        ...
        1 !== JSCompiler_inline_result.childExpirationTime
      ) {
        JSCompiler_inline_result$jscomp$0 = 0;
        for (
          renderExpirationTime$jscomp$0 = JSCompiler_inline_result.child;
          null !== renderExpirationTime$jscomp$0;

        )
          (current = renderExpirationTime$jscomp$0.expirationTime),
            (type = renderExpirationTime$jscomp$0.childExpirationTime),
            current > JSCompiler_inline_result$jscomp$0 &&
              (JSCompiler_inline_result$jscomp$0 = current),
            type > JSCompiler_inline_result$jscomp$0 &&
              (JSCompiler_inline_result$jscomp$0 = type),
            (renderExpirationTime$jscomp$0 =
              renderExpirationTime$jscomp$0.sibling);
        JSCompiler_inline_result.childExpirationTime = JSCompiler_inline_result$jscomp$0;
      }
...
var SelectEventPlugin = {
  ...
  extractEvents: function(
    ...
    if (!(JSCompiler_temp = !doc)) {
      a: {
        doc = getListenerMapForElement(doc);
