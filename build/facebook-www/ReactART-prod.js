...
var enableTrainModelFix = require("ReactFeatureFlags").enableTrainModelFix;
    ...
    case 13:
      ...
      if (null !== oldProps)
        a: for (newProps = oldProps; ; ) {
          if (5 === newProps.tag)
            (updatePayload = newProps.stateNode),
              instance
                ? updatePayload.hide()
                : ((updatePayload = newProps.memoizedProps),
            ...
            if (
              ...
              updatePayload = newProps.child.sibling;
